...
public class MainFrame extends JFrame {
    ...
    private TextArea countLabel1 = new TextArea();
    ...
    private void start() {
        ...
        SwingWorker<Boolean, Obj> worker;
        worker = new SwingWorker<Boolean, Obj>() {
            ...
            */
            ...
            protected void process(List<Obj> chunks) {
                Obj value = chunks.get(chunks.size() - 1);
                
                countLabel1.setText(i + ") Current value: " + value + "\n" + countLabel1.getText());
                i++;
            }
